...
type ComplexityRoot struct {
	Query struct {
		...
		Text func(childComplexity int, request model.TextRequestInput) int
	}
}

type QueryResolver interface {
	Ping(ctx context.Context) (string, error)
	Text(ctx context.Context, request model.TextRequestInput) ([]interface{}, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.text":
		...
		return e.complexity.Query.Text(childComplexity, args["request"].(model.TextRequestInput)), true
...
func (e *executableSchema) Exec(ctx context.Context) graphql.ResponseHandler {
	...
	inputUnmarshalMap := graphql.BuildUnmarshalerMap(
		ec.unmarshalInputTextRequestInput,
	)
	first := true
...
var sources = []*ast.Source{
	{Name: "../schema.graphqls", Input: `scalar Any

type Query {
    ping: String!
    text(request: TextRequestInput!): [Any!]!
}
...
func (ec *executionContext) field_Query_text_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
	var arg0 model.TextRequestInput
	if tmp, ok := rawArgs["request"]; ok {
		ctx := graphql.WithPathContext(ctx, graphql.NewPathWithField("request"))
		arg0, err = ec.unmarshalNTextRequestInput2serverᚋinternalᚋpackagesᚋgraphqlᚋmodelᚐTextRequestInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Query_text(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	fc, err := ec.fieldContext_Query_text(ctx, field)
	if err != nil {
		return graphql.Null
	}
	ctx = graphql.WithFieldContext(ctx, fc)
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Query().Text(rctx, fc.Args["request"].(model.TextRequestInput))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) unmarshalInputTextRequestInput(ctx context.Context, obj interface{}) (model.TextRequestInput, error) {
	var it model.TextRequestInput
	asMap := map[string]interface{}{}
	for k, v := range obj.(map[string]interface{}) {
		asMap[k] = v
	}

	fieldsInOrder := [...]string{"fileName", "payload"}
...
func (ec *executionContext) unmarshalNTextRequestInput2serverᚋinternalᚋpackagesᚋgraphqlᚋmodelᚐTextRequestInput(ctx context.Context, v interface{}) (model.TextRequestInput, error) {
	res, err := ec.unmarshalInputTextRequestInput(ctx, v)
	return res, graphql.ErrorOnPath(ctx, err)
}
